    ...
    >
      ...
      {inventory.length > 0 && (
        <input
          ...
          className="mb-3 w-full rounded-lg border border-line bg-bg-elevated px-3 py-2 text-xs text-ink outline-none placeholder:text-ink-faint focus:border-accent"
        />
      )}
